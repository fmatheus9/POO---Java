...
public class ConversorService {
    ...
    public NoticiaEntity converte_noticiaDTO(NoticiaDTO noticiaDTO){
        ...
        aux.setAdministrador(converte_admDTO(noticiaDTO.getAdministrador()));
        aux.setBlog(converte_blogDTO(noticiaDTO.getBlog()));
        return aux;
    }
    ...
    public NoticiaDTO converte_noticiaEntity(NoticiaEntity noticiaEntity){
        ...
        aux.setAdministrador(converte_admEntity(noticiaEntity.getAdministrador()));
        aux.setBlog(converte_blogEntity(noticiaEntity.getBlog()));
        return aux;
    }
